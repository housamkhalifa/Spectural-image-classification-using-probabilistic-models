function [prin_comp cov_matrxi Theta_0 Theta_1 Theta_2 Theta_3 Theta_4 Theta_5 Theta_6 Theta_7 Theta_8 Theta_9 A W] = LearnGraphStructureLasso(pca_train, train_lbls, pca_test, test_labels,lambda)
...
p(3) = multi_Gaussian_dist(pca_2_cov,cur_test',pcm2',Theta_2);
p(4) = multi_Gaussian_dist(pca_3_cov,cur_test',pcm3',Theta_3);
p(5) = multi_Gaussian_dist(pca_4_cov,cur_test',pcm4',Theta_4);
p(6) = multi_Gaussian_dist(pca_5_cov,cur_test',pcm5',Theta_5);
p(7) = multi_Gaussian_dist(pca_6_cov,cur_test',pcm6',Theta_6);
p(8) = multi_Gaussian_dist(pca_7_cov,cur_test',pcm7',Theta_7);
p(9) = multi_Gaussian_dist(pca_8_cov,cur_test',pcm8',Theta_8);
p(10) = multi_Gaussian_dist(pca_9_cov,cur_test',pcm9',Theta_9);
p = p/sum(p);
[v idx] = max(p);
cur_result(y) = idx-1;
